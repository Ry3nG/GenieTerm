    ...
    return (
        <div className="flex flex-col items-start gap-6 w-full mb-4 unselectable">
            <div className="text-secondary leading-relaxed">
                <p className="mb-0">
                    File editing now includes visual diff previews, easy rollback affordances, performance improvements,
                    and bug fixes.
                </p>
            </div>
            ...
            <div className="flex w-full items-start gap-4">
                <div className="flex-shrink-0">
                    <i className="text-[24px] text-accent fa-solid fa-eye"></i>
                </div>
                <div className="flex flex-col items-start gap-2 flex-1">
                    <div className="text-foreground text-base font-semibold leading-[18px]">Preview Workflow</div>
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            <li>Improved drag and drop handling from preview viewers</li>
                            <li>Directory listing behavior is more consistent across file widgets</li>
                            <li>Improved input validation for file operations</li>
                        </ul>
                    </div>
                </div>
            </div>
