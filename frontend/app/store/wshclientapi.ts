...
export class RpcApiType {
    ...
    AiCommandComposeCommand(
        client: WshClient,
        data: AiCommandComposeData,
        opts?: RpcOpts
    ): Promise<AiCommandComposeRtn> {
    ...
    // command "gitgraph" [call]
    GitGraphCommand(client: WshClient, data: CommandGitGraphData, opts?: RpcOpts): Promise<GitGraphResponse> {
        if (this.mockClient) return this.mockClient.mockWshRpcCall(client, "gitgraph", data, opts);
    ...
    RunCompletionGenCommand(
        client: WshClient,
        data: CommandRunCompletionGenData,
        opts?: RpcOpts
    ): Promise<CommandRunCompletionGenRtnData> {
