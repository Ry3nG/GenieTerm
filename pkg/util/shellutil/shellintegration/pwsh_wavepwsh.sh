...
# Source dynamic script from genie token
$waveterm_swaptoken_output = {{.HELPERCMD}} token $env:WAVETERM_SWAPTOKEN pwsh 2>$null | Out-String
...
{{.HELPERCMD}} completion powershell | Out-String | Invoke-Expression
