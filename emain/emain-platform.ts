...
// On macOS, it will store to ~/Library/Application \Support/genieterm/electron
// On Linux, it will store to ~/.config/genieterm/electron
// On Windows, it will store to %LOCALAPPDATA%/genieterm/electron
